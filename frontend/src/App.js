              ...
              {inputType === 'text' && (
                <div>
                  ...
                  <div className="mb-3 p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                    ...
                    <p className="text-blue-200 text-sm">{currentExample.text}</p>
                  </div>
                  <textarea
                    value={textInput}
                    onChange={(e) => setTextInput(e.target.value)}
                    placeholder={`Try this example: "${currentExample.text}" or describe your own algorithm...`}
                  ...
                  <div className="mt-2 text-xs text-slate-400">
                    💡 You can use the example above or describe any algorithm, data structure, or programming concept
                  </div>
                </div>
              )}
